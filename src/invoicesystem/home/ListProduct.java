...
public class ListProduct extends javax.swing.JFrame {
    ...
    public ListProduct() {
        ...
        this.setTitle("MiXed Invoice - List Products");
    }
    ...
    private void initComponents() {
        ...
        ProductList.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ProductList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Product ID", "Product Name", "Product Details", "Product Price", "Stock Status", "Date Created", "Time Created"
            }
        ) {
        ...
        getContentPane().add(btnListclose, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 620, 160, 50));

        btnShow.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        btnShow.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/print - 32 X 32.png"))); // NOI18N
        ...
        getContentPane().add(btnShow, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 620, 160, 50));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 620, 160, 50));
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        MessageFormat body = new MessageFormat("Product List");
        MessageFormat footer = new MessageFormat("(Page{0, number, Integer})");
        
        try {
            ProductList.print(JTable.PrintMode.FIT_WIDTH,header, footer);
